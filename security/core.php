...
<head>
	...
	<meta name="generator" content="CYBER DEFENCE" />
    <meta name="robots" content="noindex, nofollow">>
	<meta name="theme-color" content="#000000">
	<link rel="icon" type="image/png" href="https://cybersmartempire.com/favicon.png">
    <link rel="shortcut icon" href="https://cybersmartempire.com/favicon.png">
    <title>CYBER DEFENSE &rsaquo; Admin Panel</title>
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center>
  <a href="dashboard.php" class="brand-link" style="text-decoration: none; color: inherit;">
    <img src="https://cybersmartempire.com/favicon.png" alt="Cyber Smart Empire Logo" style="height: 36px; vertical-align: middle; margin-right: 8px;">
    <span class="brand-text font-weight-light" style="font-size: 20px; font-weight: 600; color: #00a651;">
      CYBER DEFENCE
    </span>
  </a>
</center>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="https://cybersmartempire.com/cyberdefence/" target="_blank">CYBER DEFENCE</a> v<?php echo $psec_version; ?></strong>

...
<div class="proxy-container">
    <div class="proxy-card">
        ...
        <div class="proxy-icon"><i class="fas fa-globe"></i></div>
        <p><?php echo html_entity_decode($row['text']); ?></p>
        <p>We’ve detected that your connection is routed through a proxy or VPN.  
        For security reasons, access to this resource has been restricted.</p>
